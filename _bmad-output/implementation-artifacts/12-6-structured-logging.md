...
- [x] Task 3: Create entity logger services (AC: #7)
  ...
  - [x] Create `apps/api/src/common/logger/auth0.logger.ts` — events: AUTH0_USER_CREATED, AUTH0_USER_CREATION_FAILED, AUTH0_USER_DELETED, AUTH0_PASSWORD_TICKET_CREATED, AUTH0_PASSWORD_TICKET_FAILED, AUTH0_TOKEN_REFRESHED
