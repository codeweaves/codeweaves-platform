/** Inline SVG icons matching lucide-react icons used in the preview.
 *  Keeps the widget dependency-free from lucide. */
...
export function SquareIcon({ class: cls = 'w-3.5 h-3.5' }: IconProps) {
  return (
    <svg class={cls} viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
export function Loader2Icon({ class: cls = 'w-4 h-4' }: IconProps) {
  return (
    <svg class={`${cls} animate-spin`} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
