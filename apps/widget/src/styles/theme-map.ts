...
export const THEME_MAP: Record<string, ThemeMapEntry> = {
  ...
  "icon.hoverBackgroundColor": {
    variable: "--cw-icon-hover-bg",
    default: "#2563eb",
    type: "color",
  },
  "icon.size": {
    variable: "--cw-icon-size",
    default: "56px",
    type: "number-px",
  },
  "icon.borderRadius": {
    variable: "--cw-icon-radius",
    default: "50%",
    type: "number-pct",
  },
  "icon.shadow": {
    variable: "--cw-icon-shadow",
  ...
  "header.backgroundColor": {
    variable: "--cw-header-bg",
    default: "#3b82f6",
    type: "color",
  },
  "header.textColor": {
    variable: "--cw-header-text",
    default: "#ffffff",
    type: "color",
  },
  "header.subtitleColor": {
    variable: "--cw-header-subtitle",
    default: "#e0e7ff",
    type: "color",
  },
  "header.borderRadius": {
    variable: "--cw-header-radius",
    default: "14px",
    type: "number-px",
  },
  ...
  "userMessage.backgroundColor": {
    variable: "--cw-msg-user-bg",
    default: "#3b82f6",
    type: "color",
  },
  "userMessage.textColor": {
    variable: "--cw-msg-user-text",
    default: "#ffffff",
    type: "color",
  },
  "userMessage.borderRadius": {
    variable: "--cw-msg-user-radius",
    default: "14px",
    type: "number-px",
  },
  ...
  "botMessage.backgroundColor": {
    variable: "--cw-msg-bot-bg",
    default: "#f3f4f6",
    type: "color",
  },
  "botMessage.textColor": {
    variable: "--cw-msg-bot-text",
    default: "#1f2937",
    type: "color",
  },
  "botMessage.borderRadius": {
    variable: "--cw-msg-bot-radius",
    default: "14px",
    type: "number-px",
  },

  // ── Bot Avatar ──────────────────────────────────────────────────────
  "botAvatar.backgroundColor": {
    variable: "--cw-avatar-bot-bg",
    default: "#e0e7ff",
    type: "color",
  },
  "botAvatar.color": {
    variable: "--cw-avatar-bot-color",
    default: "#3b82f6",
    type: "color",
  },
  ...
  "userAvatar.backgroundColor": {
    variable: "--cw-avatar-user-bg",
    default: "#dbeafe",
    type: "color",
  },
  "userAvatar.color": {
    variable: "--cw-avatar-user-color",
    default: "#3b82f6",
    type: "color",
  },
  ...
  "input.backgroundColor": {
    variable: "--cw-input-bg",
    default: "#ffffff",
    type: "color",
  },
  "input.textColor": {
    variable: "--cw-input-text",
    default: "#1f2937",
    type: "color",
  },
  "input.placeholderColor": {
    variable: "--cw-input-placeholder",
    default: "#6b7280",
    type: "color",
  },
  "input.borderColor": {
    variable: "--cw-input-border",
    default: "#e5e7eb",
    type: "color",
  },
  "input.borderRadius": {
    variable: "--cw-input-radius",
    default: "14px",
    type: "number-px",
  },
  ...
  "sendButton.hoverBackgroundColor": {
    variable: "--cw-send-hover-bg",
    default: "#2563eb",
    type: "color",
  },
  "sendButton.iconColor": {
    variable: "--cw-send-icon",
    default: "#ffffff",
    type: "color",
  },
  "sendButton.borderRadius": {
    variable: "--cw-send-radius",
    default: "14px",
    type: "number-px",
  },
  ...
  "bubble.backgroundColor": {
    variable: "--cw-bubble-bg",
    default: "#ffffff",
    type: "color",
  },
  "bubble.textColor": {
    variable: "--cw-bubble-text",
    default: "#1f2937",
    type: "color",
  },
  ...
  "typography.fontFamily": {
    variable: "--cw-font-family",
    default:
      'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
    type: "font",
  },
  "typography.baseFontSize": {
    variable: "--cw-font-size",
    default: "14px",
    type: "number-px",
  },
  ...
  "animations.transitionDuration": {
    variable: "--cw-transition-duration",
    default: "200ms",
    type: "number-ms",
  },
  ...
  // ── Branding ────────────────────────────────────────────────────────
  "branding.textColor": {
    variable: "--cw-branding-text",
    default: "#6b7280",
    type: "color",
  },
  "branding.linkColor": {
    variable: "--cw-branding-link",
    default: "#2563eb",
    type: "color",
  },
};
...
export const ALL_CSS_VARIABLES = Object.values(THEME_MAP).map(
  (e) => e.variable,
);
