        ...
        >
          {allowClear && (
            <SelectPrimitive.Item
              value={clearValue}
              className='focus:bg-accent focus:text-accent-foreground text-muted-foreground relative flex w-full cursor-pointer items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-hidden select-none'
            >
