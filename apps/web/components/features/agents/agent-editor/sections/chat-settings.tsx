  ...
  const renderHeaderSettings = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4 items-start">
        ...
        <div className="col-span-2">
          <ImageUpload
            ...
            onUpload={(url) => {
              updateThemeData("header.logoUrl", url);
              updateThemeData("header.showLogo", true);
            }}
            onRemove={() => {
              updateThemeData("header.logoUrl", undefined);
              updateThemeData("header.showLogo", false);
            }}
            agentId={agent.id}
            purpose="header-logo"
            previewShape="circle"
      ...
      <ColorPicker
        ...
        contrastAgainst={themeData.header.backgroundColor}
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              updateThemeData("botAvatar.show", checked)
            }
          />
        </div>
        ...
        {(themeData.botAvatar.show ?? false) && (
          <>
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    updateThemeData("botAvatar.type", val)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    updateThemeData("botAvatar.shape", val)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            {themeData.botAvatar.type === "custom" && (
              <div className="space-y-3">
                ...
                <ImageUpload
                  ...
                  onUpload={(url) =>
                    updateThemeData("botAvatar.customImageUrl", url)
                  }
                  onRemove={() =>
                    updateThemeData("botAvatar.customImageUrl", undefined)
                  }
                  agentId={agent.id}
                  purpose="bot-avatar"
                  previewShape="circle"
            ...
            <ColorPicker
              ...
              onChange={(color) =>
                updateThemeData("botAvatar.backgroundColor", color)
              }
              id="botAvatarBg"
            />
            ...
            <ColorPicker
              ...
              contrastAgainst={themeData.botAvatar.backgroundColor}
              contrastLevel="ui"
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              updateThemeData("userAvatar.show", checked)
            }
          />
        </div>
        ...
        {(themeData.userAvatar.show ?? false) && (
          <>
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    updateThemeData("userAvatar.type", val)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    updateThemeData("userAvatar.shape", val)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            {themeData.userAvatar.type === "custom" && (
              <div className="space-y-3">
                ...
                <ImageUpload
                  ...
                  onUpload={(url) =>
                    updateThemeData("userAvatar.customImageUrl", url)
                  }
                  onRemove={() =>
                    updateThemeData("userAvatar.customImageUrl", undefined)
                  }
                  agentId={agent.id}
                  purpose="user-avatar"
                  previewShape="circle"
            ...
            <ColorPicker
              ...
              onChange={(color) =>
                updateThemeData("userAvatar.backgroundColor", color)
              }
              id="userAvatarBg"
            />
            ...
            <ColorPicker
              ...
              contrastAgainst={themeData.userAvatar.backgroundColor}
              contrastLevel="ui"
      ...
      >
        <div className="grid grid-cols-2 gap-4">
          <ColorPicker
            ...
            onChange={(color) =>
              updateThemeData("userMessage.backgroundColor", color)
            }
            id="userMessageBg"
          />
          <ColorPicker
            ...
            contrastAgainst={themeData.userMessage.backgroundColor}
            onChange={(color) =>
              updateThemeData("userMessage.textColor", color)
            }
      ...
      >
        <div className="grid grid-cols-2 gap-4">
          <ColorPicker
            ...
            onChange={(color) =>
              updateThemeData("botMessage.backgroundColor", color)
            }
            id="systemMessageBg"
          />
          <ColorPicker
            ...
            contrastAgainst={themeData.botMessage.backgroundColor}
        ...
        <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg border">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              updateThemeData("timestamps.show", checked)
            }
          />
        </div>
      ...
      <FormSection title="Input Area" className="p-6 rounded-lg border">
        <div className="space-y-4">
          <ColorPicker
            ...
            onChange={(color) =>
              updateThemeData("input.backgroundColor", color)
            }
            id="inputBg"
          />
          ...
          <div className="grid grid-cols-3 gap-4 items-center">
            ...
            <Input
              ...
              onChange={(e) =>
                updateThemeData("input.placeholderText", e.target.value)
              }
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <ColorPicker
              ...
              onChange={(color) =>
                updateThemeData("sendButton.backgroundColor", color)
              }
              id="sendButtonBg"
            />
          </div>
          ...
          <ColorPicker
            ...
            contrastAgainst={themeData.sendButton.backgroundColor}
            contrastLevel="ui"
