...
//          -e DASHBOARD_ORIGIN=https://app.getklivo.com \
//          -e CLERK_TOKEN=eyJ... \
...
export default function () {
  ...
  const batch = http.batch([
    [
      ...
      null,
      { headers: headers(), tags: { name: "analytics/summary" } },
    ],
    [
      "GET",
      `${API}/analytics/charts/conversations?${range}`,
      null,
      { headers: headers(), tags: { name: "analytics/charts/conversations" } },
    ],
    [
      "GET",
      `${API}/analytics/handover?${range}`,
      null,
      { headers: headers(), tags: { name: "analytics/handover" } },
    ],
    [
      "GET",
      `${API}/analytics/agents?${range}`,
      null,
      { headers: headers(), tags: { name: "analytics/agents" } },
    ],
  ]);
